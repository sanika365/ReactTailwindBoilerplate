...
const Feature = () => {
  return (
    ...
    <div className='mt-10 md:text-left'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-4 mt-8 ml-4 md:ml-20 md:mt-6 justify-center items-center'>
        <div className='max-w-lg mx-auto md:ml-0 md:mr-0 md:mt-0'>
          <div className='rounded overflow-hidden shadow-lg border border-gray-300'>
            <div className='flex flex-col md:flex-row'>
              <img
                src='ss4.jpg'
                alt='Fundamental math'
                className=' md:w-48 md:h-44 object-cover md:mt-6 md:ml-4 mx-auto'
              />
              <div className='px-4 py-4'>
                ...
                <button className='bg-yellow-500 hover:bg-yellow-600 text-black font-medium mt-4 py-2 px-4 rounded-full flex items-center justify-center w-full md:w-auto'>
                  <FontAwesomeIcon icon={faBookmark} className='mr-2' />
                  <span>In Progress</span>
                </button>
              </div>
          ...
          <div className='rounded overflow-hidden shadow-lg border border-gray-300'>
            <div className='flex flex-col md:flex-row'>
              <img
                src='ss4.jpg'
                alt='Mathematical thinking'
                className='w-full md:w-48 md:h-44 object-cover md:mt-6 md:ml-4 mx-auto'
              />
              <div className='px-4 py-4'>
                <div className='font-medium text-sm text-gray-900 mb-2'>
                  7 courses
